...
// =========================================================================
// BidaInterestList — generic server-side list (search/filter/sort/page/export).
// Same engine as BidaAdvanceList; driven by a `BidaInterestListConfig` object
// inlined in the Blade:
//   {
//     tableId, dataUrl, exportUrl,
//     filterPrefix,            // "interest" -> data-interest-table-filter
//     order, pageLength,
//     columns: [ ...DataTables columns... ],
//     filters: ["status"],     // select keys -> data-<prefix>-filter="status"
//     extraData: { ... }       // optional, always-sent params
//   }
// =========================================================================
var BidaInterestList = (function () {
...
KTUtil.onDOMContentLoaded(function () {
    if (typeof BidaInterestListConfig !== "undefined") {
        BidaInterestList.init(BidaInterestListConfig);
    }
});
