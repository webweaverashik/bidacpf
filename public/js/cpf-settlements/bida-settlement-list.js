...
// =========================================================================
// BidaSettlementList — generic server-side list (search/filter/sort/page/export).
// Same engine as BidaInterestList / BidaAdvanceList; driven by a
// `BidaSettlementListConfig` object inlined in the Blade:
//   {
//     tableId, dataUrl, exportUrl,
//     filterPrefix,            // "settlement" -> data-settlement-table-filter
//     order, pageLength,
//     columns: [ ...DataTables columns... ],
//     filters: ["status", "type"]
//   }
// =========================================================================
var BidaSettlementList = (function () {
...
KTUtil.onDOMContentLoaded(function () {
    if (typeof BidaSettlementListConfig !== "undefined") {
        BidaSettlementList.init(BidaSettlementListConfig);
    }
});
