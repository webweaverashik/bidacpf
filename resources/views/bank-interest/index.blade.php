...
@section('header-title')
    @include('bank-interest.partials.page-header', ['heading' => 'Interest Distributions', 'crumbs' => ['CPF Operation', 'Bank Interest', 'Distributions']])
@endsection
            ...
            <div class="card-toolbar">
                ...
                @can('bank_interest.create')
                    <a href="{{ route('bank-interest.distribute') }}" class="btn btn-primary">
                        <i class="ki-outline ki-plus fs-2"></i>New Distribution</a>
                @endcan
            </div>
        </div>
    ...
    <script>
        var BidaInterestListConfig = {
            ...
            columns: [
                ...
                { data: 'cut_off' },
                { data: 'fiscal_year' },
                { data: 'interest', className: 'text-end' },
                { data: 'members', className: 'text-center' },
                { data: 'distributed', className: 'text-end' },
                { data: 'status' },
