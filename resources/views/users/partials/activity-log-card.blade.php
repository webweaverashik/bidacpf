            ...
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-{{ $searchAttr }}-filter="search"
                        class="form-control form-control-solid w-250px ps-13" placeholder="Search activity..." />
                </div>
            </div>
                        ...
                        <div class="px-7 py-5" data-{{ $searchAttr }}-filter="form">
                            <div class="mb-5">
                                ...
                                <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                    data-placeholder="All Events" data-allow-clear="true"
                                    data-{{ $searchAttr }}-filter="event" data-hide-search="true">
                                    <option></option>
            ...
            <table class="table table-hover align-middle table-row-dashed fs-6 gy-5 ashik-table"
                ...
                <thead>
                    <tr class="fw-bold fs-7 text-uppercase gs-0">
                        <th class="w-50px">#</th>
                        <th class="w-150px">Module</th>
                        <th class="w-120px">Event</th>
